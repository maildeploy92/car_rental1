		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Vehicles for Rent</h2>
						<div class="right">
					...
					<h2><input type="submit" onclick="window.print()" value="Generate Report" /></h2>
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<div class="sort">
							...
							<select class="field">
								<option value="">Renting Price</option>
							</select>
						</div>
						<!-- End Sort -->
...
<div id="footer">
	<div class="shell">
	<span class="left">&copy; <?php echo date("Y");?> Rent-a-car PH</span>
	<span class="right">
			</a>
		</span>
	</div>
